    ...
    221 : function(e, a, t) {
        ...
        a.a = {
            ...
            project: [{
                ...
                highlights: ["2020年10月团队合作开发的一款管理类项目，包括人员档案管理、人员信息管理、系统管理、诉求信息管理等功能；", "在此封装了高效的可复用的组件模块，通过组件化开发极大的提升了开发效率；","项目上线后用户体验流畅，用户数量不断增加，产品的销售量也在不断增多中。"]
            },{
                ...
                highlights: ["2020年04月到2020年06月独立负责开发的一款理财类项目，包括产品信息、投资理财等功能；", "前端采用微信公众号开发，在此封装了高效的可复用的组件模块，通过组件化开发极大的提升了开发效率；","项目上线后用户体验流畅，用户数量不断增加，产品的销售量也在不断增多中。"]
            },
            {
            ...
            },
            {
                ...
                highlights: ["2019年08月到2019年11月我们四人小组负责开发一款商城的项目，包括首页、分类、购物车，我的，能更好的更优惠的物品展示在客户APP上；","作为团队中的核心程序员，我负责项目的调研，根据产品需求文档进行需求拆分，技术选型与搭建框架等开发；", "让用户不仅享受购物的便利和优惠的价格，还让推广者获得劳动报酬。"]
            },
            {
                organization: "金龙鱼H5",
                position: "Web 前端工程师",
